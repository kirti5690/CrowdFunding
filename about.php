...
<!-- Mirrored from qrowd-html.vercel.app/main-html/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jul 2024 09:38:19 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title> About || Qrowd || Qrowd HTML 5 Template </title>
    <!-- favicons Icons -->
    ...
    <div class="page-wrapper">
       ...
       ?>
        ...
        <section class="page-header">
            <div class="page-header-bg" style="background-image: url(assets/images/extra/about-banner.jpg)">
            </div>
                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="about-two__left">
                            ...
                            <p class="about-two__text-1">Qrowd launched is a fundraising platform dedicated to helping people help each other. In 2024, Qrowd acquired Classy, which enables nonprofit organizations to maximize their impact through a suite of online fundraising tools..</p>
                            ...
                            <div class="about-one__person">
                                ...
                                <div class="about-one__person-content">
                                    <p class="about-one__person-name">Divyesh Sharma</p>
                    ...
                    <div class="col-xl-6">
                        <div class="about-two__right">
                            <div class="about-two__img-box">
                                ...
                                <img src="assets/images/extra/side-img.jpg" alt="">
                                </div>
                                <div class="about-two__img-two" style="width:300px;height:500px;">
                                    <img style="width:300px;height:500px;" src="assets/images/campaign/h4.jpg" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="about-two__left">
                            ...
                            <div class="about-one__person">
                                ...
                                <div class="about-one__person-content">
                                    <p class="about-one__person-name">Kevin Martin</p>
                                    <p class="about-one__person-foundation">CEO Foundation</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-6">
                        <div class="about-two__right">
                            <div class="about-two__img-box">
                                <div class="about-two__img">
                                    <img src="assets/images/resources/img-1.jpg" alt="">
                                </div>
                                <div class="about-two__img-two">
                                    <img src="assets/images/resources/img-2.jpg" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <!--Brand One End-->
        <!-- style="background-image: url(assets/images/backgrounds/changing-bg.jpg);" -->
        <!--Changing One Start-->
        <section class="changing-one changing-two">
        <div class="changing-one__bg" data-jarallax data-speed="0.2" data-imgPosition="50% 0%"
        style="background-image: url(assets/images/extra/donor-banner.jpg);"></div>
            <div class="container">
                <div class="changing-one__inner">
                    <p class="changing-one__sub-title">Thousand of Raiser</p>
                    <h2 class="changing-one__title">Qrowd is Changing the Way <br>come to life</h2>
                    <a href="registerDonor.php" class="thm-btn">Donate now</a>
                </div>
            </div>
        </section>
        <!--Changing One End-->
        
        <!-- style="background-image: url(assets/images/backgrounds/testimonial-two-bg.png);" -->
                ...
                <div class="row">
                    <div class="col-xl-4">
                        <div class="testimonial-two__left">
                            <div class="section-title text-left">
                                <span class="section-title__tagline">Our Donors</span>
                                <h2 class="section-title__title">Donor's Introduntion to world</h2>
                            </div>
                            <p class="testimonial-two__text">People around the world are donating money to the needer</p>
                        </div>
                    </div>
                    <div class="col-xl-8">
                        <div class="testimonial-two__right">
                            <div class="testimonial-two__carousel owl-carousel owl-theme thm-owl__carousel donors"
                                data-owl-options='{
                                "loop": true,
                                "autoplay": true,
                                "margin": 30,
        ...
        <section class="team-one">
            <div class="container">
                <div class="section-title text-center">
                    <span class="section-title__tagline">Meet our volunteers</span>
                    <h2 class="section-title__title">You can ask for Advice & Help <br> to Grow</h2>
                </div>
                <div class="row three">
                ...
                <div class="ready-one__inner">
                    ...
                    <div class="ready-one__left">
                        ...
                        <div class="content">
                            ...
                            <h3>“Charity isn’t about pity; it is about compassion.”</h3>
                        </div>
                    </div>
                    <div class="ready-one__right">
                        <a href="registerDonor.php" class="thm-btn ready-one__btn">Donote Now</a>
                    </div>
                </div>
            </div>
        </section>
