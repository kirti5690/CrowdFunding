...
<!-- Mirrored from qrowd-html.vercel.app/main-html/faq.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jul 2024 09:38:42 GMT -->
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
        ...
        <section class="page-header ">
            <div class="page-header-bg" style="background-image: url(assets/images/extra/donor-banner.jpg)">
            </div>
            ...
            <div class="container">
                 <div class="project-one__top"> 
                        <div class="section-title text-center">
                           <span class="section-title__tagline line pt-5 mt-5">Donors Associated with Different Campaigns</span>
                           <h2 class="section-title__title line1"> Know About Our Donors and <br> Check Thier Donations </h2>
                       </div>
                  </div>
                 <div class="donor_card">
                    <div class=" row donor">
                     ...
                     <div class="row">
    <div class="col-12">
      <ul class="pagination justify-content-end pb-5 mb-5"></ul>
    </div>
  </div>

                 </div>
            <div id="campaign-details" style="display: none;">
                <button onclick="showDonors()"><-</button>
                <div class="container">
                    <div class="project-one__top"> 
                       <div class="section-title text-center">
                          <span class="section-title__tagline">Donated Campagins by Donor</span>
                          <h2 class="section-title__title">Learn about the Campaign and <br> Donate now </h2>
                        </div>
                    </div>
                    <div class="project-one__bottom pb-5 mb-5">
