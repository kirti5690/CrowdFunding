...
<script>
    ...
    function validateForm() {
        ...
        if (address === "") {
            $("#contactError").text("*Please write your address");
            isValid = false;
        }
        if (occupation === "") {
            $("#userOccupationError").text("*Please write your occupation");
            isValid = false;
        }
        if (description === "") {
    ...
    $('#fundraiser-register-form').on('submit', function(event) {
        ...
        formData.append('action', 'registerVol');
    ...
    validateField("#t2", "#userOccupationError", "*Please enter your occupation");
    validateField("#t4", "#userIdError", "*Please enter your email");
    validateField("#t5", "#contactError", "*Please enter your address");
         ...
         <section>
            ...
            <div class="container">
                <div class="page-header__inner pt-5 mt-5 pb-5 mb-5">
                    ...
                    <h2 style="font-size:28px;">Welcome,Create Your Account as Volunteer <span class="ps-2" style="font-size:38px;"><i class="fa-solid fa-user"></i></span></h2>
                </div>
            </div>
            </div>
        </section> 
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-lg-8">
                ...
                <form class="login-register__form" id="fundraiser-register-form" enctype="multipart/form-data">
                   <input type="hidden" name="action" value="regiterVol">
                   ...
                   <div class="contact-form__input-box">
                    ...
                    <div class="contact-form__input-box">
                        <input type="text" name="occupation" id="t2" placeholder="Occupation" required>
                    </div>
                    <div id="userOccupationError" class="error-message"></div>

                    
                    <div class="contact-form__input-box">
                        <input type="text" name="email" id="t4" placeholder="Email" required>
                    </div>
                   <div id="userIdError" class="error-message"></div>
                    
                    
                   <div class="contact-form__input-box">
                        <input type="text" name="address" id="t5" placeholder="Address" required>
                    </div>
